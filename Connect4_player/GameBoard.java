...
public class GameBoard 
{
     ...
     * currently, it uses for loops for each type of way to score. I'm sure that there are probably
     * a more efficient way to do it but I just wanted it to work.
     * 
	...
	public int getThree( int player ) 
    {
	//reset the scores
	int playerScore = 0;
